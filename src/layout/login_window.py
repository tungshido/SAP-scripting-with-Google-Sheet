...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lbl_department = QtWidgets.QLabel(self.centralwidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbl_department.sizePolicy().hasHeightForWidth())
        self.lbl_department.setSizePolicy(sizePolicy)
        self.lbl_department.setObjectName("lbl_department")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.lbl_department)
        self.cbx_department = QtWidgets.QComboBox(self.centralwidget)
        self.cbx_department.setEnabled(True)
        self.cbx_department.setMinimumSize(QtCore.QSize(0, 30))
        self.cbx_department.setEditable(False)
        self.cbx_department.setObjectName("cbx_department")
        self.cbx_department.addItem("")
        self.cbx_department.addItem("")
        self.cbx_department.addItem("")
        self.cbx_department.addItem("")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.cbx_department)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.lbl_username)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.txt_username)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.LabelRole, self.lbl_password)
        ...
        self.formLayout.setWidget(6, QtWidgets.QFormLayout.FieldRole, self.txt_password)
        ...
        self.formLayout.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.lbl_credit)
        self.gridLayout.addLayout(self.formLayout, 1, 0, 1, 1)
        self.btn_credit = QtWidgets.QPushButton(self.centralwidget)
        self.btn_credit.setMaximumSize(QtCore.QSize(100, 16777215))
        self.btn_credit.setDefault(True)
        self.btn_credit.setFlat(False)
        self.btn_credit.setObjectName("btn_credit")
        self.gridLayout.addWidget(self.btn_credit, 2, 0, 1, 1, QtCore.Qt.AlignHCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "SAP scripting toolbox"))
        self.label_3.setText(_translate("MainWindow", "SAP SCRIPTING TOOLBOX"))
        self.lbl_department.setText(_translate("MainWindow", "Chọn bộ phận"))
        self.cbx_department.setCurrentText(_translate("MainWindow", "OE"))
        self.cbx_department.setItemText(0, _translate("MainWindow", "OE"))
        self.cbx_department.setItemText(1, _translate("MainWindow", "Planning"))
        self.cbx_department.setItemText(2, _translate("MainWindow", "Warehouse"))
        self.cbx_department.setItemText(3, _translate("MainWindow", "Equipment"))
        ...
        self.btn_credit.setText(_translate("MainWindow", "Credits"))
